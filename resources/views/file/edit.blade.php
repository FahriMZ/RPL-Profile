...
<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ URL::to('File/'.$file->id.'/edit') }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nama_file') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nama_file" type="text" class="form-control" name="nama_file" value="{{ $file->nama_file }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('link_file') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="5" id="link_file" type="text" class="form-control" name="link_file" required autofocus>{{ $file->link_file }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('deskripsi_file') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="deskripsi_file" rows="5" id="deskripsi_file" class="form-control" required>{{ $file->deskripsi_file }}</textarea>
