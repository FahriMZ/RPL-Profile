...
<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ URL::to('Guru/'.$guru->id.'/edit') }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nip" type="text" class="form-control" name="nip" value="{{ $guru->nip }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nama_guru') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nama_guru" type="text" class="form-control" name="nama_guru" value="{{ $guru->nama_guru }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('jabatan_guru') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jabatan_guru" type="text" class="form-control" name="jabatan_guru" value="{{ $guru->jabatan_guru }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('deskripsi_guru') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="deskripsi_guru" rows="10" id="deskripsi_guru" class="form-control" required>{{ $guru->deskripsi_guru }}</textarea>
