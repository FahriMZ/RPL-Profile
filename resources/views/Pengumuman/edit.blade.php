...
<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ URL::to('Pengumuman/'.$pengumuman->id.'/edit') }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('judul_pengumuman') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="judul_pengumuman" type="text" class="form-control" name="judul_pengumuman" value="{{ $pengumuman->judul_pengumuman }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('jam_pengumuman') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jam_pengumuman" type="time" class="form-control" name="jam_pengumuman" value="{{ $pengumuman->jam_pengumuman }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('tanggal_pengumuman') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_pengumuman" type="date" class="form-control" name="tanggal_pengumuman" value="{{ $pengumuman->tanggal_pengumuman }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('isi_pengumuman') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="isi_pengumuman" rows="10" id="isi_pengumuman" class="form-control" required>{{ $pengumuman->isi_pengumuman }}</textarea>
