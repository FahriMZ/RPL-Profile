...
<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ URL::to('Agenda/'.$agenda->id.'/edit') }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('judul_agenda') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="judul_agenda" type="text" class="form-control" name="judul_agenda" value="{{ $agenda->judul_agenda }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('tanggal_agenda') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_agenda" type="date" class="form-control" name="tanggal_agenda" value="{{ $agenda->tanggal_agenda }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('isi_agenda') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="isi_agenda" rows="10" id="isi_agenda" class="form-control" required>{{ $agenda->isi_agenda }}</textarea>
