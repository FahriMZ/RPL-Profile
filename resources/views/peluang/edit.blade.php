...
<div class="panel panel-default">
                <div class="panel-heading">Edit Lowongan Kerja</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ URL::to('Peluang/'.$peluang->id.'/edit') }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nama_pekerjaan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nama_pekerjaan" type="text" class="form-control" name="nama_pekerjaan" value="{{ $peluang->nama_pekerjaan }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nama_perusahaan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nama_perusahaan" type="text" class="form-control" name="nama_perusahaan" value="{{ $peluang->nama_perusahaan }}" required autofocus>
