...
<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ URL::to('Berita/'.$berita->id.'/edit') }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('judul_berita') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="judul_berita" type="text" class="form-control" name="judul_berita" value="{{ $berita->judul_berita }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('tanggal_berita') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_berita" type="date" class="form-control" name="tanggal_berita" value="{{ $berita->tanggal_berita }}" required autofocus>
