...
insert  into `buku_pesan`(`id`,`nama`,`email`,`pesan`,`dibuat`) values 
(1,'test','guest@nonono.cm','Ini pesan dari guest','2018-02-11 22:47:01'),
(2,'dasf','test@gmail.com','Ini pesan dari guest','2018-02-11 22:47:19'),
(4,'d','TESTESTEST@GMIAL.CIN','FASDFASDF','2018-02-11 22:49:16'),
(5,'d','TESTESTEST@GMIAL.CIN','FASDFASDF','2018-02-11 22:50:46'),
(6,'d','TESTESTEST@GMIAL.CIN','FASDFASDF','2018-02-11 22:51:05'),
(7,'d','TESTESTEST@GMIAL.CIN','FASDFASDF','2018-02-11 22:51:20'),
(8,'d','TESTESTEST@GMIAL.CIN','FASDFASDF','2018-02-11 22:52:07'),
(9,'fgghjkl;','test@gmail.com','dfghjkljghjk','2018-02-11 22:53:34'),
(10,'njfkmdcxm','TESTESTEST@GMIAL.CIN',',smd.sm','2018-02-11 22:54:35'),
(11,'cvbnm,','mzfahri620@gmail.com','cadskflsadjfklsjdf','2018-02-11 22:55:19');
...
(4,'Countdown JS (FIXED)','https://codeload.github.com/rendro/countdown/zip/master','A Countdown for release time in javascript.'),
...
insert  into `guru`(`id`,`nip`,`nama_guru`,`deskripsi_guru`,`jabatan_guru`) values 
(1,'198012272014102002','Ani Nuraeni,S.Kom','Guru Mata Pelajaran Prod. Rekayasa Perangkat Lunak\r\nLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.\r\nLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.\r\nLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.','Ketua Kompetensi Keahlian TIK'),
(2,NULL,'Himatul Munawaroh,ST','Guru Mata Pelajaran Prod. Rekayasa Perangkat Lunak','Guru RPL'),
(3,NULL,'Rini Melati, S.Kom','Guru Mata Pelajaran Prod. Rekayasa Perangkat Lunak','Guru RPL'),
...
(7,'1234567890','Test','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.','test'),
(9,NULL,'kals;ff;la',NULL,NULL);
...
CREATE TABLE `kolom_guru` (
  ...
  `tipe_karya` varchar(50) DEFAULT NULL,
  `judul_karya` varchar(50) NOT NULL,
  `karya` text,
  `tanggal_dipost` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `id_guru` (`id_guru`),
  CONSTRAINT `kolom_guru_ibfk_1` FOREIGN KEY (`id_guru`) REFERENCES `guru` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

/*Data for the table `kolom_guru` */

insert  into `kolom_guru`(`id`,`id_guru`,`tipe_karya`,`judul_karya`,`karya`,`tanggal_dipost`) values 
(1,5,'puisi','Ini','ini<br>\r\nini adalah ini<br>\r\nbukan itu.','2018-02-16 21:43:49'),
(2,4,'cerita','Lorem','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\n      tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\n      quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n      consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\n      cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\n      proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','2018-02-16 22:04:31'),
(3,4,'cerita','Lorem Lor','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\n      tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\n      quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n      consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\n      cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\n      proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\r\nLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\n      tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\n      quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\n      consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\n      cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\n      proident, sunt in culpa qui officia deserunt mollit anim id est laborum.','2018-02-16 22:18:55'),
(4,5,'puisi','Ini','ini<br>\r\nini adalah ini<br>\r\nbukan itu.','2018-02-16 21:43:49');
...
(1,'Jangwen','jangwen@gmail.com','$2y$10$VkTxb/FyPkIwG6Wn.myIeenY3QcAGXFA8MEHVPCRyyRIgh0eI5ItW','NehGuDikcMJ1sCj2Oouih1q3sL5ktDSJ10n6FYDsGnVBSBfiMcx9EgcYCGah','2018-02-05 06:09:22','2018-02-05 06:09:22');
